// Main function: mx_noise3d_vector4
...
// Main function from mx_noise3d_vector4.glsl
fn mx_noise3d_vector4_(amplitude_4: vec4<f32>, pivot: f32, position: vec3<f32>, result_10: ptr<function, vec4<f32>>) {
    ...
    xyz = _e9;
    let _e11 = position_1;
    let _e20 = mx_perlin_noise_float_1((_e11 + vec3<f32>(19f, 73f, 29f)));
    w_2 = _e20;
    let _e22 = xyz;
    let _e23 = w_2;
    let _e28 = amplitude_5;
    let _e30 = pivot_1;
    (*result_10) = ((vec4<f32>(_e22.x, _e22.y, _e22.z, _e23) * _e28) + vec4(_e30));
    return;
}