// Main function: mx_noise3d_vector3
...
// Main function from mx_noise3d_vector3.glsl
fn mx_noise3d_vector3_(amplitude_4: vec3<f32>, pivot: f32, position: vec3<f32>, result_10: ptr<function, vec3<f32>>) {
    ...
    value = _e9;
    let _e11 = value;
    let _e12 = amplitude_5;
    let _e14 = pivot_1;
    (*result_10) = ((_e11 * _e12) + vec3(_e14));
    return;
}