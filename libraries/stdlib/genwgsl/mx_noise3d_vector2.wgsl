// Main function: mx_noise3d_vector2
...
// Main function from mx_noise3d_vector2.glsl
fn mx_noise3d_vector2_(amplitude_4: vec2<f32>, pivot: f32, position: vec3<f32>, result_10: ptr<function, vec2<f32>>) {
    ...
    position_1 = position;
    let _e8 = position_1;
    let _e9 = mx_perlin_noise_vec3_1(_e8);
    value = _e9;
    let _e11 = value;
    let _e13 = amplitude_5;
    let _e15 = pivot_1;
    (*result_10) = ((_e11.xy * _e13) + vec2(_e15));
    return;
}