// Main function: mx_noise2d_vector2
...
// Main function from mx_noise2d_vector2.glsl
fn mx_noise2d_vector2_(amplitude_4: vec2<f32>, pivot: f32, texcoord: vec2<f32>, result_10: ptr<function, vec2<f32>>) {
    ...
    texcoord_1 = texcoord;
    let _e8 = texcoord_1;
    let _e9 = mx_perlin_noise_vec3_(_e8);
    value = _e9;
    let _e11 = value;
