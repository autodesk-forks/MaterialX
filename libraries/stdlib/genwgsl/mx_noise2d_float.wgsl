// Main function: mx_noise2d_float
...
// Main function from mx_noise2d_float.glsl
fn mx_noise2d_float(amplitude_4: f32, pivot: f32, texcoord: vec2<f32>, result_10: ptr<function, f32>) {
    var amplitude_5: f32;
    var pivot_1: f32;
    ...
    texcoord_1 = texcoord;
    let _e8 = texcoord_1;
    let _e9 = mx_perlin_noise_float(_e8);
    value = _e9;
    let _e11 = value;
