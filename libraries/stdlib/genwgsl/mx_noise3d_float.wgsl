// Main function: mx_noise3d_float
...
// Main function from mx_noise3d_float.glsl
fn mx_noise3d_float(amplitude_4: f32, pivot: f32, position: vec3<f32>, result_10: ptr<function, f32>) {
    var amplitude_5: f32;
    var pivot_1: f32;
    ...
    position_1 = position;
    let _e8 = position_1;
    let _e9 = mx_perlin_noise_float_1(_e8);
    value = _e9;
    let _e11 = value;
    let _e12 = amplitude_5;
    let _e14 = pivot_1;
    (*result_10) = ((_e11 * _e12) + _e14);
    return;
}