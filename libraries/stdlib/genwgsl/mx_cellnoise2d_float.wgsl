// Main function: mx_cellnoise2d_float
...
// Main function from mx_cellnoise2d_float.glsl
fn mx_cellnoise2d_float(texcoord: vec2<f32>, result_10: ptr<function, f32>) {
    var texcoord_1: vec2<f32>;

    texcoord_1 = texcoord;
    let _e4 = texcoord_1;
    let _e5 = mx_cell_noise_float_1(_e4);
    (*result_10) = _e5;
    return;
}