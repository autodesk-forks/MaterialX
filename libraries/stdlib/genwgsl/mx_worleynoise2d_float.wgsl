// Main function: mx_worleynoise2d_float
...
// Main function from mx_worleynoise2d_float.glsl
fn mx_worleynoise2d_float(texcoord: vec2<f32>, jitter_20: f32, style_12: i32, result_10: ptr<function, f32>) {
    ...
    let _e9 = jitter_21;
    let _e10 = style_13;
    let _e12 = mx_worley_noise_float(_e8, _e9, _e10, 0i);
    (*result_10) = _e12;
    return;
}