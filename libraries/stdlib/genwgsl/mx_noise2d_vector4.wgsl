// Main function: mx_noise2d_vector4
...
// Main function from mx_noise2d_vector4.glsl
fn mx_noise2d_vector4_(amplitude_4: vec4<f32>, pivot: f32, texcoord: vec2<f32>, result_10: ptr<function, vec4<f32>>) {
    ...
    xyz = _e9;
    let _e11 = texcoord_1;
    let _e18 = mx_perlin_noise_float((_e11 + vec2<f32>(19f, 73f)));
    w_2 = _e18;
    let _e20 = xyz;
    let _e21 = w_2;
    let _e26 = amplitude_5;
    let _e28 = pivot_1;
    (*result_10) = ((vec4<f32>(_e20.x, _e20.y, _e20.z, _e21) * _e26) + vec4(_e28));
    return;
}