// Main function: mx_rgbtohsv_color3
...
// Main function from mx_rgbtohsv_color3.glsl
fn mx_rgbtohsv_color3_(_in: vec3<f32>, result: ptr<function, vec3<f32>>) {
    var _in_1: vec3<f32>;

    _in_1 = _in;
    let _e4 = _in_1;
    let _e5 = mx_rgbtohsv(_e4);
    (*result) = _e5;
    return;
}