// Main function: mx_hsvtorgb_color4
...
// Main function from mx_hsvtorgb_color4.glsl
fn mx_hsvtorgb_color4_(_in: vec4<f32>, result: ptr<function, vec4<f32>>) {
    var _in_1: vec4<f32>;

    _in_1 = _in;
    let _e4 = _in_1;
    let _e6 = mx_hsvtorgb(_e4.xyz);
