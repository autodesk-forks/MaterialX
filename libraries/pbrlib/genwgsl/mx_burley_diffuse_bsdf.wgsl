// Main function: mx_burley_diffuse_bsdf
...
// Main function from mx_burley_diffuse_bsdf.glsl
fn mx_burley_diffuse_bsdf(closureData: ClosureData, weight: f32, color_4: vec3<f32>, roughness_24: f32, N_14: vec3<f32>, bsdf: ptr<function, BSDF>) {
    ...
    V_7 = _e20.V;
    let _e23 = closureData_1;
    L_7 = _e23.L;
    let _e26 = N_15;
    let _e27 = V_7;
    let _e28 = mx_forward_facing_normal(_e26, _e27);
    N_15 = _e28;
    let _e29 = N_15;
    let _e30 = V_7;
    NdotV_16 = clamp(dot(_e29, _e30), 0.00000001f, 1f);
    let _e36 = closureData_1;
    if (_e36.closureType == 1i) {
        {
            let _e40 = N_15;
            let _e41 = L_7;
            NdotL_7 = clamp(dot(_e40, _e41), 0.00000001f, 1f);
            let _e47 = L_7;
            let _e48 = L_7;
            let _e49 = V_7;
            LdotH_2 = clamp(dot(_e47, normalize((_e48 + _e49))), 0.00000001f, 1f);
            let _e58 = color_5;
            let _e59 = closureData_1;
            let _e62 = weight_1;
            let _e64 = NdotL_7;
            (*bsdf).response = ((((_e58 * _e59.occlusion) * _e62) * _e64) * 0.31830987f);
            let _e71 = (*bsdf);
            let _e73 = NdotV_16;
            let _e74 = NdotL_7;
            let _e75 = LdotH_2;
            let _e76 = roughness_25;
            let _e77 = mx_burley_diffuse(_e73, _e74, _e75, _e76);
            (*bsdf).response = (_e71.response * _e77);
            return;
        }
    } else {
        let _e79 = closureData_1;
        if (_e79.closureType == 3i) {
            {
                let _e83 = N_15;
                let _e84 = mx_environment_irradiance(_e83);
                let _e85 = NdotV_16;
                let _e86 = roughness_25;
                let _e87 = mx_burley_diffuse_dir_albedo(_e85, _e86);
                Li = (_e84 * _e87);
                let _e91 = Li;
                let _e92 = color_5;
                let _e94 = weight_1;
                (*bsdf).response = ((_e91 * _e92) * _e94);
                return;
            }
        } else {
            return;
