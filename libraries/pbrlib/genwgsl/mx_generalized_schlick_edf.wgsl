// Main function: mx_generalized_schlick_edf
...
// Included from lib/mx_microfacet.glsl (WGSL)
...
// Main function from mx_generalized_schlick_edf.glsl
fn mx_generalized_schlick_edf(closureData: ClosureData, color0_: vec3<f32>, color90_: vec3<f32>, exponent_4: f32, base: vec3<f32>, result: ptr<function, vec3<f32>>) {
    ...
    base_1 = base;
    let _e12 = closureData_1;
    if (_e12.closureType == 4i) {
        {
            let _e16 = closureData_1;
            let _e18 = closureData_1;
            let _e20 = mx_forward_facing_normal(_e16.N, _e18.V);
            N_6 = _e20;
            let _e22 = N_6;
            let _e23 = closureData_1;
            NdotV = clamp(dot(_e22, _e23.V), 0.00000001f, 1f);
            let _e30 = NdotV;
            let _e31 = color0_1;
            let _e32 = color90_1;
            let _e33 = exponent_5;
            let _e34 = mx_fresnel_schlick_5(_e30, _e31, _e32, _e33);
            f = _e34;
            let _e36 = base_1;
            let _e37 = f;
            (*result) = (_e36 * _e37);
