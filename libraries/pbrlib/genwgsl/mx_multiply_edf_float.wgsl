// Main function: mx_multiply_edf_float
...
// Main function from mx_multiply_edf_float.glsl
fn mx_multiply_edf_float(closureData: ClosureData, in1_: vec3<f32>, in2_: f32, result: ptr<function, vec3<f32>>) {
