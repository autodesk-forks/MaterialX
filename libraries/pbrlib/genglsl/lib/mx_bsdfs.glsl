...
float mx_microfacet_sheen_albedo(float cosTheta, float roughness)
{
   ...
   float fx = x - ix;
   float fy = y - iy;
   return mx_mix(u_sheenAlbedo[iy  * SHEEN_ALBEDO_TABLE_SIZE + ix],
                 u_sheenAlbedo[iy  * SHEEN_ALBEDO_TABLE_SIZE + ix2],
                 u_sheenAlbedo[iy2 * SHEEN_ALBEDO_TABLE_SIZE + ix],
                 u_sheenAlbedo[iy2 * SHEEN_ALBEDO_TABLE_SIZE + ix2],
                 fx, fy);
}
