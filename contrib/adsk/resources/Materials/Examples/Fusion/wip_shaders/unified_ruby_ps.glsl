...
uniform float transparent_ior = 1.770000;
uniform vec3 transparent_color = vec3(0.977692, 0.151704, 0.151704);
uniform float transparent_distance = 2.000000;
