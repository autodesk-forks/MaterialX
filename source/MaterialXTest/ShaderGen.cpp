...
void createLightRig(mx::DocumentPtr doc, mx::LightHandler& lightHandler, mx::HwShaderGenerator& shadergen)
{
    ...
    dirLight->setParameter("direction", mx::Color3(0, 0, -1));
    ...
    pointLight->setParameter("position", mx::Color3(200, 200, 50));
    ...
    spotLight->setParameter("position", mx::Color3(350, 350, 100));
    spotLight->setParameter("direction", mx::Color3(0, 0, -1));
    ...
    compoundLight->setParameter("position", mx::Color3(200, 400, 50));
