...
EMSCRIPTEN_BINDINGS(element)
{
    ...
    ems::class_<mx::ValueElement, ems::base<mx::TypedElement>>("ValueElement")
        ...
        .function("_getValue", &mx::ValueElement::getValue)
        BIND_MEMBER_FUNC("_getResolvedValue", mx::ValueElement, getResolvedValue, 0, 1, mx::StringResolverPtr)
        .function("_getDefaultValue", &mx::ValueElement::getDefaultValue)
