...
public:
    ...
    void createUniform(size_t stage, const string& block, const TypeDesc* type, const string& name, const string& elementPath, const string& semantic = EMPTY_STRING, ValuePtr value = nullptr) override;
