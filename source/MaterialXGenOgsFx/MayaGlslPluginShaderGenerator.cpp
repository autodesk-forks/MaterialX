...
void MayaGlslPluginShader::createUniform(size_t stage, const string& block, const TypeDesc* type, const string& name, 
                                         const string& path, const string& semantic, ValuePtr value, UIProperties* ui)
{
    ...
    {
        HwShader::createUniform(stage, block, type, name, path, VIEW_POSITON_SEMANTIC, value, ui);
        return;
    }
    ParentClass::createUniform(stage, block, type, name, path, semantic, value, ui);
}
