...
RtStagePtr RtApi::loadLibraries(const RtString& name, const FilePathVec& libraryPaths, const RtReadOptions* options, bool forceReload)
{
    return _cast(_ptr)->loadLibraries(name, libraryPaths, options, forceReload);
}
