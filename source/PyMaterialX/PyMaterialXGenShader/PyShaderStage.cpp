...
void bindPyShaderStage(py::module& mod)
{
    ...
    py::class_<mx::VariableBlock, mx::VariableBlockPtr>(mod, "VariableBlock")
        ...
        .def("add", static_cast<mx::ShaderPort* (mx::VariableBlock::*)(const mx::TypeDesc*, const std::string&, mx::ValuePtr)>(&mx::VariableBlock::add))
        .def("add", static_cast<void (mx::VariableBlock::*)(mx::ShaderPortPtr)>(&mx::VariableBlock::add))
    ...
    py::class_<mx::ShaderStage>(mod, "ShaderStage")
        ...
        .def("createUniformBlock", &mx::ShaderStage::createUniformBlock)
        .def("createInputBlock", &mx::ShaderStage::createInputBlock)
        .def("createOutputBlock", &mx::ShaderStage::createOutputBlock)
