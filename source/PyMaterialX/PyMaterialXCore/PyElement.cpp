...
void bindPyElement(py::module& mod)
{
    ...
    py::class_<mx::Element, mx::ElementPtr>(mod, "Element")
        ...
        .def("setUnit", &mx::Element::setUnit)
        .def("hasUnit", &mx::Element::hasUnit)
        .def("getUnit", &mx::Element::getUnit)
        .def("getActiveUnit", &mx::Element::getActiveUnit)
        ...
        .def_readonly_static("NAME", &mx::Element::NAME_ATTRIBUTE)
        .def_readonly_static("FILEPREFIX", &mx::Element::FILE_PREFIX_ATTRIBUTE)
        .def_readonly_static("GEOMPREFIX", &mx::Element::GEOM_PREFIX_ATTRIBUTE)
        .def_readonly_static("COLORSPACE", &mx::Element::COLOR_SPACE_ATTRIBUTE)
        .def_readonly_static("UNITLENGTH", &mx::Element::LENGTH_UNIT_ATTRIBUTE)
        .def_readonly_static("TARGET", &mx::Element::TARGET_ATTRIBUTE)
        .def_readonly_static("VERSION", &mx::Element::VERSION_ATTRIBUTE)
        .def_readonly_static("DEFAULTVERSION", &mx::Element::DEFAULT_VERSION_ATTRIBUTE)
        .def_readonly_static("INHERIT", &mx::Element::INHERIT_ATTRIBUTE)
        .def_readonly_static("NAMESPACE", &mx::Element::NAMESPACE_ATTRIBUTE)
    ...
    py::class_<mx::TypedElement, mx::TypedElementPtr, mx::Element>(mod, "TypedElement")
        ...
        .def_readonly_static("TYPE", &mx::TypedElement::TYPE_ATTRIBUTE);
    ...
    py::class_<mx::ValueElement, mx::ValueElementPtr, mx::TypedElement>(mod, "ValueElement")
        ...
        .def_readonly_static("VALUE", &mx::ValueElement::VALUE_ATTRIBUTE)
        .def_readonly_static("INTERFACENAME", &mx::ValueElement::INTERFACE_NAME_ATTRIBUTE)
        .def_readonly_static("IMPLNAME", &mx::ValueElement::IMPLEMENTATION_NAME_ATTRIBUTE)
        .def_readonly_static("IMPLTYPE", &mx::ValueElement::IMPLEMENTATION_TYPE_ATTRIBUTE)
        .def_readonly_static("ENUM", &mx::ValueElement::ENUM_ATTRIBUTE)
        .def_readonly_static("ENUMVALUES", &mx::ValueElement::ENUM_VALUES_ATTRIBUTE)
        .def_readonly_static("UINAME", &mx::ValueElement::UI_NAME_ATTRIBUTE)
