...
void bindPyElement(py::module& mod)
{
    ...
    py::class_<mx::ValueElement, mx::ValueElementPtr, mx::TypedElement>(mod, "ValueElement")
        ...
        .def("setUnitString", &mx::ValueElement::setUnitString)
        .def("hasUnitString", &mx::ValueElement::hasUnitString)
        .def("getUnitString", &mx::ValueElement::getUnitString)
        ...
        .def_readonly_static("UNIT", &mx::ValueElement::UNIT_ATTRIBUTE)
