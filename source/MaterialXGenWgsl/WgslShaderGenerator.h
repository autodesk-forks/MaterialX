...
/// Base class for WGSL (WebGPU Shading Language) code generation.
/// A generator for a specific WGSL target should be derived from this class.
class MX_GENWGSL_API WgslShaderGenerator : public HwShaderGenerator
{
  public:
    ...
    /// Return the version string for the WGSL version this generator is for
